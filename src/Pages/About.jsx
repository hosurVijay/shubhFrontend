      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-12 lg:px-28 py-14">
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700 leading-relaxed text-base">
            ...
            thoughtful design. Our goal is to remove confusion from traditional
            planning while preserving the emotional and spiritual depth of every
            ceremony.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="rounded-xl bg-orange-50 p-5 border border-orange-100">
              <p className="text-gray-900 font-medium mb-2">Unified Planning</p>
              <p className="text-gray-700 text-sm leading-relaxed">
                From muhurta selection to coordination with purohitas and event
                essentials, we bring everything into one seamless platform so
                families can plan without stress.
              </p>
            </div>
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700 leading-relaxed text-base">
            ...
            platform that empowers families to plan ceremonies with confidence,
            clarity, and trust.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed text-base mb-2">
            Traditional planning is often fragmented, unclear, and dependent on
            multiple sources. Shubhakarya brings structure and reliability into
            this process while maintaining its cultural authenticity.
          </p>
          <p className="text-gray-700 leading-relaxed text-base">
            We focus equally on
